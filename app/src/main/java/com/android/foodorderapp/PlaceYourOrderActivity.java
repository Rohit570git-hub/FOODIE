...
public class PlaceYourOrderActivity extends AppCompatActivity {
    ...
    private TextView tvItemTotal, tvdeliverychargeValue,tvTaxesvalue, tvTaxesnChargesValue, tvCashRound, tvDeliveryCharge, tvGrandTotalValue, buttonPlaceYourOrder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_place_your_ordertest);
        ...
        tvItemTotal = findViewById(R.id.textViewItemTotalValue);
        tvTaxesnChargesValue=findViewById(R.id.textViewtaxeschargeValue);
        tvdeliverychargeValue = findViewById(R.id.textViewDeliveryChargeValue);
        tvDeliveryCharge = findViewById(R.id.textViewDeliveryCharge);
        tvTaxesvalue=findViewById(R.id.textViewTaxesValue);
        tvCashRound=findViewById(R.id.textViewCashRoundOffValue);
        tvGrandTotalValue = findViewById(R.id.textViewGrandTotalValue);
...
//        });
    ...
    private void calculateTotalAmount(RestaurantModel restaurantModel) {
        ...
        tvItemTotal.setText("$"+String.format("%.2f", subTotalAmount));
        if(isDeliveryOn) {
            tvdeliverychargeValue.setText("$"+String.format("%.2f", restaurantModel.getDelivery_charge()));
            subTotalAmount += restaurantModel.getDelivery_charge();
        }


        tvGrandTotalValue.setText("$"+String.format("%.2f", subTotalAmount));
    }
