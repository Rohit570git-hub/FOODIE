...
public class MenuListAdapter extends RecyclerView.Adapter<MenuListAdapter.MyViewHolder> {
    ...
    public MenuListAdapter(Context context,List<Menu> menuList, MenuListClickListener clickListener) {
        ;
    ...
    public void onBindViewHolder(@NonNull MenuListAdapter.MyViewHolder holder, int position) {
        ...
        int foodtype=menuList.get(position).getFoodtype();
        if(foodtype==1){
            holder.foodSymbol.setImageResource(R.drawable.nonvegi);
            holder.foodSymbolName.setText("Non-Veg");
            GradientDrawable magnitudeCircle = (GradientDrawable) holder.foodSymbolName.getBackground();
            magnitudeCircle.setColor(ContextCompat.getColor(holder.itemView.getContext(),R.color.red));
        }else {
            holder.foodSymbol.setImageResource(R.drawable.vegicon);
            holder.foodSymbolName.setText("    Veg    ");
            GradientDrawable magnitudeCircle = (GradientDrawable) holder.foodSymbolName.getBackground();
            magnitudeCircle.setColor(ContextCompat.getColor(holder.itemView.getContext(),R.color.green));
        }
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView  foodSymbol;
        TextView foodSymbolName;
        ImageView thumbImage;
        TextView imageMinus;
        TextView imageAddOne;
        TextView  tvCount;
        ...
        public MyViewHolder(View view) {
            ...
            foodSymbol=view.findViewById(R.id.foodSymbol);
            foodSymbolName=view.findViewById(R.id.foodSymbolName);
